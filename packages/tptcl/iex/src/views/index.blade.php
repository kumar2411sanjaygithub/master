...
@section('content')
    ...
    <h5><label  class="control-label"><u>PERMISION PACKAGE LIST</u></label></h5>
      <ol class="breadcrumb">
            ...
            <tbody>
                  ...
                  @forelse ($permissions as $k=>$permission)
                     <tr>
                       ...
                       <td>
                        <a href="{{url('task/edit/'.$permission->id)}}"><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;&nbsp;&nbsp;
                     ...
                     ->id }}" class="modal fade" role="dialog">
                         <form method="POST"  action="{{url('task/delete/'.$permission->id)}}">
                          {{ csrf_field() }}
                          {{ method_field('DELETE') }}
