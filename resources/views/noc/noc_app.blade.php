...
.default-c{background-color: #868686;}
</style>
<style>
                  ...
                  @if (count($noc_data) > 0)
                     ...
                     <tr>
                        ...
                        <td class="vl">
                          ...
                          @else
                            <a href="" data-toggle="modal" data-target="#deleteData{{ $noc_list->id }}" class="@if(($noc_list->status==2 ||$noc_list->status==3)) @else disabled @endif"><span class="label default-c fnt " >ADD</span></a>
                          @endif
                        </td>
                        <td class="vl">
