   ...
   <section class="content-header">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-5 text-right saroa" style="margin-top:10px;">
          <input type="checkbox" class="minimal1" id="saroa">&nbsp<span><label for="saroa">SAME AS REGISTERED OFFICE ADDRESS</label></span>
        </div>
      </div>
            <div class="row">
              <div class="col-md-3">
        ...
        <div class="col-md-5"></div>
        <div class="col-md-5 text-right saba">
          <input type="checkbox" class="minimal1" id="saba">&nbsp<span><label for="saba">SAME AS BILLING ADDRESS</label></span>
        </div>
        </div>
            <div class="row">
              <div class="col-md-3">
