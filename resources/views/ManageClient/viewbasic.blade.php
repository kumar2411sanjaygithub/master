		...
		<section class="content">
			...
			<div class="row">
				...
				<div class="col-md-5 text-right" style="margin-top:10px;">
					<input type="checkbox" class="minimal disabled-class" id="#saroa">&nbsp<span>SAME AS REGISTERED OFFICE ADDRESS </span>
				</div>
			</div>
						<div class="row">
							<div class="col-md-3">
			...
			<input type="checkbox" class="minimal disabled-class" id="saba">&nbsp<span>SAME AS BILLING ADDRESS</span>
				</div>
			</div>
						<div class="row">
							<div class="col-md-3">
