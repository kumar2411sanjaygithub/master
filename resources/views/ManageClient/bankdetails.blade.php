...
.divshow{
 ...
 <section class="content-header">
  ...
  <form method ="post" action="{{isset($get_bank_details)?url('bank_edit/'.$get_bank_details->id):route('bank_create')}}">
      {{ csrf_field() }}
  <div class="row {{isset($get_bank_details)?'':'divhide'}}" id="bankbox">
  <div class="col-xs-12">
  <div class="box">
  <div class="box-body">
    <div class="row">
    ...
    <div class="row">
      ...
      <div class="row">
         ...
         @if(isset($get_bank_details))
          ...
          @endif
          <div class="col-md-1"><input type="button" class="btn btn-block btn-danger btn-xs" id="bn7" name="bn7" value="Cancel"></div>
        <div class="col-md-5"></div>
      </div>
    </div>
    </div>
